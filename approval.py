...
def lambda_handler(event, context):
    ...
    action = data["approval"]["actionName"]
    print(action)
                ...
                "actions": [
                    {
                        ...
                        "style": "danger",
                        "type": "button",
                        "value": json.dumps({"approve": True, "codePipelineToken": token, "codePipelineName": codepipeline_name, "action":action}),
                        "confirm": {
                            "title": "Are you sure?",
                    ...
                    },
                    {
                        ...
                        "text": "No",
                        "type": "button",
                        "value": json.dumps({"approve": False, "codePipelineToken": token, "codePipelineName": codepipeline_name, "action":action})
                    }  
                ]
            }
        ]
